...
export function provide(state: IState, config: IConfig, fsf: IFsFunctions): Promise<CompletionItem[]> {
...
export function getNpmPackages(state: IState, config: IConfig, fsf: IFsFunctions) {
...
function getPackageJson(state: IState, config: IConfig, fsf: IFsFunctions): string {
...
function nearestPackageJson(rootPath: string, currentPath: string, fsf: IFsFunctions): string {
...
function readModuleSubFolders(dependencies: string[], state: IState, fsf: IFsFunctions) {
